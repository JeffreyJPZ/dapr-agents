...
TOPIC_NAME = os.getenv("TOPIC_NAME", "low-stock-events")
ITEM_ID = os.getenv("ITEM_ID", "SKU789")  # used when RAW_DATA is not provided
STOCK_LEVEL = int(os.getenv("STOCK_LEVEL", "5"))  # used when RAW_DATA is not provided
